...
(setq text "Breakpoint 1 set at line 13 of file /src/git/code/gcd.py")
...
(setq text "(c:\\working\\python\\helloworld.py:30): <module>")
...
(setq text "(/tmp/eval_stringzDKTfr.py:1 remapped <string>): <module>")
(assert-t (numberp (loc-match text helper-loc))   "position location")
